...
export default function HeroSection() {
  return (
    <section className="relative -mt-[74px] min-h-screen overflow-x-clip pt-[74px] sm:-mt-[70px] sm:pt-[70px]">
      {/* Fondo */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 -z-30 bg-[radial-gradient(circle_at_20%_15%,rgba(124,58,237,0.25),transparent_35%),radial-gradient(circle_at_85%_65%,rgba(168,85,247,0.18),transparent_35%),linear-gradient(145deg,#07040b_0%,#160a23_48%,#09060f_100%)]"
      />

      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-32 -top-24 -z-20 h-[28rem] w-[28rem] rounded-full bg-violet-600/20 blur-[120px]"
      />

      <div
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-48 -right-32 -z-20 h-[32rem] w-[32rem] rounded-full bg-fuchsia-500/15 blur-[140px]"
      />

      {/* Contenido */}
      <div className="mx-auto grid min-h-[100svh] w-full max-w-7xl items-center gap-7 px-5 pb-10 pt-24 sm:px-6 md:gap-10 md:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-12 lg:pb-12 lg:pt-28">
        {/* Texto */}
        <div className="relative z-20 order-2 mx-auto w-full max-w-xl text-center lg:order-1 lg:mx-0 lg:text-left">
          <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-[#b99cff] sm:text-xs">
            Desarrollo y diseño web
          </p>

          <h1 className="text-[clamp(2rem,8vw,4.7rem)] font-semibold leading-[0.96] tracking-[-0.05em]">
            Creador de sitios web
            <span className="mt-1 block text-white/70">para tu negocio.</span>
          </h1>

          <div className="mt-5 text-sm leading-relaxed text-white/60 sm:text-base md:mt-6">
            <p>Recibe una vista previa de tu página en menos de 24 horas.</p>
          ...
          <div className="mt-6 flex w-full flex-col gap-2.5">
            <a
              ...
              className="flex min-h-12 w-full items-center justify-center gap-2 rounded-full bg-[#22c55e] px-7 text-sm font-semibold text-white shadow-[0_14px_34px_rgba(34,197,94,0.2)] transition duration-300 hover:-translate-y-0.5 hover:bg-[#16a34a] active:scale-[0.97]"
            >
            ...
            <a
              href="#projects"
              className="flex min-h-12 w-full items-center justify-center rounded-full bg-[#7c3aed] px-7 text-sm font-semibold text-white shadow-[0_14px_34px_rgba(124,58,237,0.25)] transition duration-300 hover:-translate-y-0.5 hover:bg-[#8b5cf6] active:scale-[0.97]"
            >
              Ver mis proyectos
            </a>
          </div>
        ...
        <div className="relative order-1 mx-auto flex w-full max-w-[760px] items-center justify-center lg:order-2">
          ...
          <div
            aria-hidden="true"
            className="absolute left-1/2 top-1/2 h-[55%] w-[62%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-violet-600/10 blur-[55px]"
          />

          {/* Mockup 10% más pequeño */}
          <div className="mockup-float relative mx-auto w-[90%]">
            ...
            <div className="relative mx-auto w-[96%] max-w-[690px] -rotate-[1.5deg]">
              ...
              {/* Base laptop */}
              <div className="relative mx-auto h-[13px] w-[104%] -translate-x-[2%] rounded-b-[55%] bg-gradient-to-b from-[#302945] via-[#171320] to-[#08070b] shadow-[0_16px_26px_rgba(0,0,0,0.55)] sm:h-[20px]">
            ...
            <div
              aria-hidden="true"
              className="absolute -bottom-[9%] left-[8%] -z-10 h-[14%] w-[80%] rounded-full bg-black/60 blur-2xl"
            />
          </div>
        </div>
      </div>
