...
export default function SobreNosotros() {
  const [mapLoaded, setMapLoaded] = useState(false); // ⬅️ estado de carga
    ...
    <div className="bg-gray-10 w-full h-auto">
      ...
      <section className="max-w-3xl mx-auto px-4 py-4 space-y-3 sm:space-y-4">
        ...
        <div className="bg-purple-100 rounded-2xl p-3 shadow-md hover:shadow-xl transition flex flex-col gap-2">
          ...
          <div className="w-full h-48 rounded-xl overflow-hidden border-2 border-purple-300 shadow-lg relative">
            ...
            <iframe
              ...
              allowFullScreen
              loading="lazy"
              onLoad={() => setMapLoaded(true)} // ⬅️ desactiva skeleton
            ></iframe>
          </div>
        </div>
      </section>
